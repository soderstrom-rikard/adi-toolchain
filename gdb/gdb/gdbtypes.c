...
#if 0
  /* BFIN extensions */
  builtin_type_bfin_ext_big =
    init_type (TYPE_CODE_FLT, floatformat_bfin_ext_big.totalsize / 8,
	       0, "builtin_type_bfin_ext_big", NULL);
  TYPE_FLOATFORMAT (builtin_type_bfin_ext_big) = &floatformat_bfin_ext_big;
  builtin_type_bfin_ext_littlebyte_bigword =
    init_type (TYPE_CODE_FLT, floatformat_bfin_ext_littlebyte_bigword.totalsize / 8,
	       0, "builtin_type_bfin_ext_littlebyte_bigword", NULL);
  TYPE_FLOATFORMAT (builtin_type_bfin_ext_littlebyte_bigword) = &floatformat_bfin_ext_littlebyte_bigword;
#endif
