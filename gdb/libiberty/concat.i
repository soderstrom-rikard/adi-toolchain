     ...
     va_list args;
{
  ...
  for (arg = first; arg ; arg = ( args  = (__gnuc_va_list) ((char *) ( args ) + (((sizeof (   const char *  ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) ),	*((  const char *  *) (void *) ((char *) ( args )	- ((sizeof (  const char * ) < (((sizeof ( char ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) 	? sizeof (  const char * ) : (((sizeof (   const char *  ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) ))))) )
    length += strlen (arg);
...
concat_length  (const char *first, ...)  
{
  ...
  { va_list  args ; (  args   = ((__gnuc_va_list) __builtin_next_arg (    first  ))) ; { struct Qdmy ;
  struct Qdmy ;
