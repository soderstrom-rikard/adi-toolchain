...
objalloc_create ()
{
  ...
  ret->current_ptr = (char *) chunk + ((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)) ;
  ret->current_space = (4096 - 32)  - ((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)) ;
     ...
     unsigned long len;
{
  ...
  len = (len + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1) &~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1);
  ...
  if (len >= (512) )
    {
      ...
      ret = (char *) malloc (((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1))  + len);
      if (ret == ((void *)0) )
	return ((void *)0) ;
      ...
      return (void * ) (ret + ((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)) );
    }
  else
    {
      struct objalloc_chunk *chunk;
	...
	return ((void *)0) ;
      ...
      o->current_ptr = (char *) chunk + ((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)) ;
      o->current_space = (4096 - 32)  - ((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)) ;

      o->chunks = (void * ) chunk;

      return __extension__	({ struct objalloc *__o = ( o );	unsigned long __len = (  len );	if (__len == 0)	__len = 1;	__len = (__len + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1) &~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1);	(__len <= __o->current_space	? (__o->current_ptr += __len,	__o->current_space -= __len,	(void * ) (__o->current_ptr - __len))	: _objalloc_alloc (__o, __len)); }) ;
    }
}
     ...
     void *  block;
{
  ...
  for (p = (struct objalloc_chunk *) o->chunks; p != ((void *)0) ; p = p->next)
	...
	{
	  if (b == (char *) p + ((sizeof (struct objalloc_chunk) + ((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)	&~ (((size_t) &(( struct objalloc_align  *)0)->  d )   - 1)) )
	    break;
	}
    }
