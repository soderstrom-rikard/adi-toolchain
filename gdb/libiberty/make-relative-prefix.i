     ...
     const char *prefix;
{
  ...
  if (lbasename (progname) == progname)
      ...
      if (temp)
	{
	  ...
	  nstore = (char *) __builtin_alloca( prefixlen + strlen (progname) + 1 ) ;
