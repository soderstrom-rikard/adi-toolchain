...
extern splay_tree_node splay_tree_insert          
					        ...
					        splay_tree_key,
					        splay_tree_value)  ;
extern void splay_tree_remove		 (splay_tree,
						splay_tree_key)  ;
...
extern int splay_tree_foreach            (splay_tree,
					        ...
					        void*)  ;
extern int splay_tree_compare_ints       (splay_tree_key,
						splay_tree_key)  ;
extern int splay_tree_compare_pointers   (splay_tree_key,
						splay_tree_key)  ;
...
static void splay_tree_delete_helper     (splay_tree, 
						splay_tree_node)  ;
