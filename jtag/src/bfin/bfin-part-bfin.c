...
static void
bfin_dbgctl_init (part_t *part, uint16_t v)
{
  register_init_value (part->active_instruction->data_register->in, v);
}

static uint16_t
bfin_dbgstat_value (part_t *part)
{
...
bfin_init ()
{
  ...
  part_init_register ("BF533", bfin_part_init);
  part_init_register ("BF534", bfin_part_init);
  part_init_register ("BF537", bfin_part_init);
  part_init_register ("BF538", bfin_part_init);
  part_init_register ("BF548", bfin_part_init);
  part_init_register ("BF561", bfin_part_init);
}
