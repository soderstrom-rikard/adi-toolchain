...
static tree
bfin_handle_l1_text_attribute (tree *node, tree name, tree args ATTRIBUTE_UNUSED,
...
static tree
bfin_handle_l1_data_attribute (tree *node, tree name, tree args ATTRIBUTE_UNUSED,
			       int flags ATTRIBUTE_UNUSED, bool *no_add_attrs)
{
  tree decl = *node;
