...
******************************************************************************
  ...
  IPDC, Bangalore,   18 July 2000.

  Modified for
  1) Denominator comparison for float 1.0.
  2) Take care of the testcases like  1.0/2.0 on : 27 September 2000
 
	Modified for new instruction set   
    and  tested using Dev13 toolset on    : 13 October 2000

   Modified for correcting  rounding method and also optimizing loop on : October 10, 2001
********************************************************************************/
#define BIASEXP 		0x7F
#define MAXEXP          0XFF  
