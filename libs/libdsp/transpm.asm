...
******************************************************************************
  ...
  Operand        : void transpmf (const float _matrix[],
  ...
  Registers Used : R0-3, P0-1, I0, B0, M0, L0

  Cycle count    : 52 + Number of samples
                   n = 100: 152 Cycles  (BF532, Cycle Accurate Simulator)
  Code size      : 66 Bytes
******************************************************************************/
...
CPY_A_2_C_START:  [I0++M0] = R3;
CPY_A_2_C_END:    R3 = [P0++];

#else

        LSETUP (CPY_A_2_C, CPY_A_2_C) LC0 = P1; 
CPY_A_2_C:  R3 = [P0++] || [I0++M0] = R3;  
