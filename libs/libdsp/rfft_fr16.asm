 ...
 ******************************************************************************
  ...
  Algorithm      : The computation of the FFT is split into three parts.
                   ...
                   implementations. The prototypes for these functions are:
                      ...
                      void _rfftN_fr16 (const complex_fract16  input[],
                      ...
                      void _rfftrad4_fr16 (const complex_fract16  input[],
                                                 complex_fract16  temp[],
                                                 complex_fract16  output[],
                                        const complex_fract16  twiddle_table[],
                                        int  twiddle_stride, int  fft_size,
...
.end_bitrev:
        ...
        P3 = P0 + (P5 << 1);           // Configure read pointer 
        ...
        P3 += -2;                      // End of real data in buffer
...
/** First stage **/
        ...
        I0 += M2;                      // End of complex data in buffer

        CC = R6 == 2;                  // Test for dynamic scaling
        IF CC R6 = R7;                 // R6 = 1 if scaling, 0 otherwise

        R3 = W[P3--](Z);               // Load data[(fft_size / 2) - 1]
    
        R2 = W[P3--](Z);               // Load data[(fft_size / 2) - 2]
...
.first_s_end:
           ...
           R3 = R3 >>> 1 (V) || R4 = W[P3--](Z);
           R6 = R2 +|+ R3, R7 = R2 -|- R3;
           R4 = R4 >>> 1 (V) || [I0--] = R7 || R3 = W[P3--](Z);
           R5 = R5 >>> 1 (V) || [I0--] = R6 || R2 = W[P3--](Z);
           R6 = R4 +|+ R5, R7 = R4 -|- R5;
           [I0--] = R7;
.first_s_end:
           [I0--] = R6;
