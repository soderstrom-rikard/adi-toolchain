...
/*
** yvals.h for ADIDSP's version 4.0.4 library
*/
...
**   _ADI_FLOAT_ENDIAN -- 0 for big endian, 3 for little endian floating-point
**   _ADI_SUPPORT_LONG_DOUBLE -- defined if long double type supported by target
**   _ADI_SUPPORT_WCHAR_WCSFTIME -- defined if wcsftime() is supported by target
**   _ADI_WCHART_UNSIGNED -- define to unsigned if wchar_t is unsigned
**   _ADI_ABRTNUM -- number of SIGABRT
**   _ADI_SIGMAX -- one more than last signal code
**   _ADI_TARG_INT16 -- define to 1 when target ints are 16-bit, zero otherwise
**   _ADI_TARG_MBMAX -- max multi-char bytes for target, to define MB_LEN_MAX
**   _ADI_ALIGNA -- storage alignment adjustment
**   _ADI_BYTE_BITS -- bits per target byte
**   _Sizet -- size_t type
...
# elif defined(__ADSP21XX__)
   /* configuration for 218x and 219x targets */
#  define _ADI_FLOAT_ENDIAN                 0
#  define _ADI_TARG_INT16                   1
#  define _ADI_TARG_MBMAX                   1
#  define _ADI_BYTE_BITS                    16
   typedef int _Ptrdifft;
   typedef unsigned int _Sizet;
#  define _ADI_ALIGNA                       1U
#  if defined(__ADSP218X__)
#   define _ADI_ABRTNUM                     11
#   define _ADI_SIGMAX                      17
#  else
#   define _ADI_ABRTNUM                     16
#   define _ADI_SIGMAX                      22
#  endif
...
# elif defined(__ADSPTS__)
   /* configuration for Tigersharc targets */
#ifdef __EXCEPTIONS
#  define _HAS_EXCEPTIONS	1
#endif
#  define _ADI_FLOAT_ENDIAN                 3
#  define _ADI_SUPPORT_LONG_DOUBLE          1
#  define _ADI_ABRTNUM                      64
#  define _ADI_SIGMAX                       70
#  define _ADI_TARG_INT16                   0
#  define _ADI_ALIGNA                       1U
...
# if defined(_ADI_WCHART_UNSIGNED)
