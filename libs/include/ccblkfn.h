...
void *__builtin_bfin_alloca(int _i);

long __builtin_bfin_circindex(long _l, long _l2, unsigned long _ul);
void *__builtin_bfin_circptr(const void *_pcv, long _l, const void *_pcv2, unsigned long _ul);
...
/* The following builtins allow for efficient loads and stores from
** misaligned addresses, without the need for using #pragma pack() */
short __builtin_bfin_misaligned_load16(void *_pv);
short __builtin_bfin_misaligned_load16_vol(volatile void *_pvv);
void __builtin_bfin_misaligned_store16(void *_pv, short _s);
void __builtin_bfin_misaligned_store16_vol(volatile void *_pvv, short _s);

int __builtin_bfin_misaligned_load32(void *_pv);
int __builtin_bfin_misaligned_load32_vol(volatile void *_pvv);
void __builtin_bfin_misaligned_store32(void *_pv, int _i);
void __builtin_bfin_misaligned_store32_vol(volatile void *_pvv, int _i);

long long __builtin_bfin_misaligned_load64(void *_pv);
long long __builtin_bfin_misaligned_load64_vol(volatile void *_pvv);
void __builtin_bfin_misaligned_store64(void *_pv, long long _ll);
void __builtin_bfin_misaligned_store64_vol(volatile void *_pvv, long long _ll);
...
static int __divs(int _x, int _y, int *_paq) {
  _x = __builtin_bfin_divs_r1(_x, _y);
  *_paq = __builtin_bfin_divs_r2(_x);
  return _x;
}

#pragma inline
static int __divq(int _x, int _y, int *_paq) {
  _x = __builtin_bfin_divq_r1(_x, _y, *_paq);
  *_paq = __builtin_bfin_divq_r2(_x);
  return _x;
}
...
#define __builtin_bfin_divs(X, Y, PAQ) __divs((X), (Y), (PAQ))
#define __builtin_bfin_divq(X, Y, PAQ) __divq((X), (Y), (PAQ))

#endif

#define __lvitmax2x16(A, B, C, D, E) { \
  (D) = __builtin_bfin_lvitmax2x16_r1((A), (B), (C)); \
  (E) = __builtin_bfin_lvitmax2x16_r2(D); \
}

#define __rvitmax2x16(A, B, C, D, E) { \
  (D) = __builtin_bfin_rvitmax2x16_r1((A), (B), (C)); \
  (E) = __builtin_bfin_rvitmax2x16_r2(D); \
}

#define __lvitmax1x16(A, B, C, D) { \
  (C) = __builtin_bfin_lvitmax1x16_r1((A), (B)); \
  (D) = __builtin_bfin_lvitmax1x16_r2(C); \
}

#define __rvitmax1x16(A,B,C,D) { \
  (C) = __builtin_bfin_rvitmax1x16_r1((A),(B)); \
  (D) = __builtin_bfin_rvitmax1x16_r2(C); \
}
...
#define __builtin_bfin_lvitmax2x16 __lvitmax2x16
#define __builtin_bfin_rvitmax2x16 __rvitmax2x16
#define __builtin_bfin_lvitmax1x16 __lvitmax1x16
#define __builtin_bfin_rvitmax1x16 __rvitmax1x16
...
#define ssync_int() __builtin_bfin_ssync_int()
#define csync() __builtin_bfin_csync()

#define csync_int() __builtin_bfin_csync_int()
...
#define alloca(N) __builtin_bfin_alloca(N)
...
extern int __builtin_bfin_testset_05000248(char *_s);
#else
extern int __builtin_bfin_testset(char *_s);
#endif
extern void __builtin_bfin_untestset(char *_s);
...
#ifdef __WORKAROUND_L2_TESTSET_STALL
  tVal = __builtin_bfin_testset_05000248((char *) _t);
#else
  tVal = __builtin_bfin_testset((char *) _t);
#endif
  while (tVal == 0) {
    __builtin_bfin_csync();
#ifdef __WORKAROUND_L2_TESTSET_STALL
...
static int adi_try_lock(testset_t *_t) {
  __builtin_bfin_csync();
#ifdef __WORKAROUND_L2_TESTSET_STALL
    return __builtin_bfin_testset_05000248((char *) _t);
#else
    return __builtin_bfin_testset((char *) _t);
#endif
}
...
static void adi_release_lock(testset_t *_t) {
  __builtin_bfin_untestset((char *) _t);
