...
__fixsfsi:
        ...
        R0=255 (X);
        CC = R3==R0;
        IF !CC JUMP fixsfsi_3;
        CC = R7==0;
        R0=-1;
        R0 <<= 0x1f;
        IF !CC JUMP fixsfsi_19;
        R0.L =-1;
        R0.H =32767;
        JUMP.S fixsfsi_19;
...
fixsfsi_3:
        CC = R3==0;
        IF CC JUMP fixsfsi_11;
        CC = R2<0;
        IF !CC JUMP fixsfsi_10;
...
__fixunssfsi:
        ...
        R0=255 (X);
        CC = R3==R0;
        IF !CC JUMP fixunssfsi_3;
        CC = R6==0;
        IF !CC JUMP fixunssfsi_4;
        R1=-1;
        R0.L =-1;
        R0.H =32767;
        R2=1;
        R2 <<= 0x17;
        CC = R7==R2;
        JUMP.S fixunssfsi_20;
 
fixunssfsi_4:
        R0=-1;
        R0 <<= 0x1f;
        JUMP.S fixunssfsi_19;
 
fixunssfsi_3:
        CC = R3==0;
        IF CC JUMP fixunssfsi_11;
        CC = R2<0;
        IF !CC JUMP fixunssfsi_10;
...
fixunssfsi_10:
        R0=23;
        CC = R2<=R0;
        IF !CC JUMP fixunssfsi_12;
        R0 = R0-R2;
        R1 = R7;
        R1 >>>= R0;
        R0= -R1;
        JUMP.S fixunssfsi_21;
 
fixunssfsi_12:
        R1=31;
        CC = R2<=R1;
        IF !CC JUMP fixunssfsi_14;
        R2 +=-23;
        R1 = R7;
        R1 <<= R2;
        R0= -R1;
...
.align 2
.global ___fixsfdi;
.type ___fixsfdi, STT_FUNC;
.global __fixsfdi;
.type __fixsfdi, STT_FUNC;
...
__fixsfdi:
        ...
        R0=255 (X);
        CC = R2==R0;
        IF !CC JUMP fixsfdi_3;
        CC = R6==0;
        IF !CC JUMP fixsfdi_4;
        R0=-1;
        R1.L =-1;
        R1.H =32767;
        JUMP.S fixsfdi_19;
...
fixsfdi_3:
        CC = R2==0;
        IF CC JUMP fixsfdi_11;
        CC = R3<0;
        IF !CC JUMP fixsfdi_10;
...
.type ___fixunssfdi, STT_FUNC;
.global __fixunssfdi;
.type __fixunssfdi, STT_FUNC;
...
__fixunssfdi:
        ...
        R0=255 (X);
        CC = R2==R0;
        IF !CC JUMP fixunssfdi_3;
        CC = R6==0;
        IF !CC JUMP fixunssfdi_4;
        R0=-1;
        R1=-1;
        JUMP.S fixunssfdi_19;
...
fixunssfdi_3:
        CC = R2==0;
        IF CC JUMP fixunssfdi_11;
        CC = R3<0;
        IF !CC JUMP fixunssfdi_10;
...
fixunssfdi_10:
        ...
        P2 = R3;
        CC = R6==0;
        IF CC JUMP fixunssfdi_15;
        SP +=-8;
        [SP]=R1;
        JUMP.S fixunssfdi_20;
 
fixunssfdi_12:
        R0=63;
        CC = R3<=R0;
        IF !CC JUMP fixunssfdi_14;
        R2 = R7;
        R2 >>>= 0x1f;
        R0 = R7;
        SP +=-8;
...
fixunssfdi_14:
        CC = R6==0;
        IF !CC JUMP fixunssfdi_17;
        R2=-1;
        R3.L =-1;
        R3.H =32767;
        JUMP.S fixunssfdi_18; 
...
.align 2
.global ___negdf2;
.type ___negdf2, STT_FUNC;
.global __negdf2;
.type __negdf2, STT_FUNC;
___negdf2:
__negdf2:
	LINK 0x0;
        SP+=-0xC;
