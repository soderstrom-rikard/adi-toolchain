...
00000000 <.text>:
  ...
  3c:	10 9e 00 00 
  40:	0c cc 76 45 	R5=A1.L\+A1.H,R2=A0.L\+A0.H || \[I2--\]=R0 || NOP;
  44:	90 9e 00 00 
  ...
  9c:	10 92 00 00 
  a0:	36 cc 02 2a 	R5=BYTEOP2P\(R1:0x0,R3:0x2\)\(TL, R\) || \[P2--\]=R0 || NOP;
  a4:	90 92 00 00 
  ...
  dc:	28 93 00 00 
  e0:	18 cc c0 45 	\(R7,R2\)=BYTEUNPACKR1:0x0  || \[P5\+\+\]=R0 || NOP;
  e4:	28 92 00 00 
  e8:	18 cc 90 69 	\(R6,R4\)=BYTEUNPACKR3:0x2 \(R\) || \[P5--\]=R0 || NOP;
  ec:	a8 92 00 00 
