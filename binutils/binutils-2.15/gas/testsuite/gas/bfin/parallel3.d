...
00000000 <.text>:
  ...
  74:	50 93 00 00 
  78:	01 cc 63 bf 	R5=R4\+|\+R3,R7=R4-|-R3 || \[P2\+\+\]=P0 || NOP;
  7c:	50 92 00 00 
  80:	01 cc 1e c2 	R0=R3\+|\+R6,R1=R3-|-R6\(ASL\) || \[P2--\]=P0 || NOP;
  84:	d0 92 00 00 
  88:	21 cc ca 2d 	R7=R1\+|-R2,R6=R1-|\+R2 || \[P2\+0x24\]=P0 || NOP;
  8c:	50 be 00 00 
  ...
  a4:	58 92 00 00 
  a8:	11 cc f6 0b 	R7=A1\+A0,R5=A1-A0 \(NS\) || \[P3--\]=P0 || NOP;
  ac:	d8 92 00 00 
  b0:	11 cc f6 6c 	R3=A0\+A1,R6=A0-A1 \(S\) || \[P3\+0x1c\]=P0 || NOP;
  b4:	d8 bd 00 00 
  b8:	81 ce 8b 03 	R1=R3 << -15 \(V\) || \[P3\+0x18\]=P0 || NOP;
  bc:	98 bd 00 00 
  c0:	81 ce e0 09 	R4=R0 << -4 \(V\) || \[P4\]=P0 || NOP;
  c4:	60 93 00 00 
  c8:	81 ce 00 4a 	R5=R0 >>> 0x0 \(V, S\) || \[P4\+\+\]=P0 || NOP;
  cc:	60 92 00 00 
  d0:	81 ce 62 44 	R2=R2 >>> -12 \(V, S\) || \[P4--\]=P0 || NOP;
  d4:	e0 92 00 00 
  d8:	01 ce 15 0e 	R7= ASHIFT R5BYR2.L\(V\) || \[P4\+0x18\]=P0 || NOP;
  dc:	a0 bd 00 00 
  e0:	01 ce 02 40 	R0= ASHIFT R2BYR0.L\(V,S\) || \[P4\+0x14\]=P0 || NOP;
  e4:	60 bd 00 00 
  e8:	81 ce 8a 8b 	R5=R2 >> 0xf \(V\) || \[P4\+0x10\]=P0 || NOP;
  ec:	20 bd 00 00 
  f0:	81 ce 11 00 	R0=R1 << 0x2 \(V\) || \[P4\+0xc\]=P0 || NOP;
  f4:	e0 bc 00 00 
  f8:	01 ce 11 88 	R4=SHIFTR1BYR2.L\(V\) || \[P5\]=P0 || NOP;
  fc:	68 93 00 00 
