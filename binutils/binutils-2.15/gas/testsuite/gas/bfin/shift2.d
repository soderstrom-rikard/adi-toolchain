...
00000000 <.text>:
  ...
  64:	80 c6 88 01 	R0.L=R0.L<<0x31;
  68:	80 c6 00 10 	R0.L=R0.H<<0x0;
  6c:	80 c6 88 11 	R0.L=R0.H<<0x31;
  70:	80 c6 00 20 	R0.H=R0.L<<0x0;
  74:	80 c6 88 21 	R0.H=R0.L<<0x31;
  78:	80 c6 00 30 	R0.H=R0.H<<0x0;
  7c:	80 c6 88 31 	R0.H=R0.H<<0x31;
  80:	80 c6 01 00 	R0.L=R1.L<<0x0;
  84:	80 c6 89 01 	R0.L=R1.L<<0x31;
  88:	80 c6 01 10 	R0.L=R1.H<<0x0;
  8c:	80 c6 89 11 	R0.L=R1.H<<0x31;
  90:	80 c6 01 20 	R0.H=R1.L<<0x0;
  94:	80 c6 89 21 	R0.H=R1.L<<0x31;
  98:	80 c6 01 30 	R0.H=R1.H<<0x0;
  9c:	80 c6 89 31 	R0.H=R1.H<<0x31;
  a0:	80 c6 07 00 	R0.L=R7.L<<0x0;
  a4:	80 c6 8e 03 	R1.L=R6.L<<0x31;
  a8:	80 c6 05 14 	R2.L=R5.H<<0x0;
  ac:	80 c6 8c 17 	R3.L=R4.H<<0x31;
  b0:	80 c6 03 28 	R4.H=R3.L<<0x0;
  b4:	80 c6 8a 2b 	R5.H=R2.L<<0x31;
  b8:	80 c6 01 3c 	R6.H=R1.H<<0x0;
  bc:	80 c6 88 3f 	R7.H=R0.H<<0x31;
 ...
 1bc:	81 40       	R1<<=R0;
 1be:	b9 40       	R1<<=R7;
 1c0:	00 c6 38 16 	R3.L= ASHIFT R0.HBYR7.L;
 1c4:	00 c6 38 26 	R3.H= ASHIFT R0.LBYR7.L;
 1c8:	00 c6 38 36 	R3.H= ASHIFT R0.HBYR7.L;
 1cc:	00 c6 38 06 	R3.L= ASHIFT R0.LBYR7.L;
 1d0:	00 c6 38 56 	R3.L= ASHIFT R0.HBYR7.L\(S\);
 1d4:	00 c6 38 66 	R3.H= ASHIFT R0.LBYR7.L\(S\);
 1d8:	00 c6 38 76 	R3.H= ASHIFT R0.HBYR7.L\(S\);
 1dc:	00 c6 38 46 	R3.L= ASHIFT R0.LBYR7.L\(S\);
 1e0:	02 c6 3a 08 	R4= ASHIFT R2BYR7.L;
 1e4:	02 c6 3a 48 	R4= ASHIFT R2BYR7.L\(S\);
 1e8:	03 c6 38 00 	A0= ASHIFT A0BYR7.L;
 1ec:	03 c6 38 10 	A1= ASHIFT A1BYR7.L;
 1f0:	13 45       	P3=P2>>1;
 1f2:	db 44       	P3=P3>>2;
 1f4:	2d 5b       	P4=P5<<1;
 1f6:	48 44       	P0=P1<<2;
 ...
 224:	43 40       	R3>>=R0;
 226:	8b 40       	R3<<=R1;
 228:	00 c6 10 86 	R3.L= LSHIFT R0.LBYR2.L;
 22c:	00 c6 10 a6 	R3.H= LSHIFT R0.LBYR2.L;
 230:	03 c6 38 40 	A0= LSHIFT A0BYR7.L;
 234:	03 c6 38 50 	A1= LSHIFT A1BYR7.L;
 238:	82 c6 f9 c8 	R4= ROT R1BY0x1f;
 23c:	82 c6 01 c9 	R4= ROT R1BY-32;
 240:	82 c6 29 c8 	R4= ROT R1BY0x5;
 244:	83 c6 b0 80 	A0= ROT A0BY0x16;
 248:	83 c6 00 81 	A0= ROT A0BY-32;
 24c:	83 c6 f8 80 	A0= ROT A0BY0x1f;
 250:	83 c6 00 91 	A1= ROT A1BY-32;
 254:	83 c6 f8 90 	A1= ROT A1BY0x1f;
 258:	83 c6 b0 90 	A1= ROT A1BY0x16;
 25c:	02 c6 11 c8	R4= ROT R1BYR2.L;
 260:	03 c6 18 80	A0= ROT A0BYR3.L;
 264:	03 c6 38 90 	A1= ROT A1BYR7.L;
