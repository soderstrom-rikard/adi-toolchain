...
00000000 <.text>:
 ...
 5f4:	01 c6 11 80 	R0=SHIFTR1 BY R2.L\(V\);
 5f8:	01 c6 2c 86 	R3=SHIFTR4 BY R5.L\(V\);
 5fc:	01 c6 07 8c 	R6=SHIFTR7 BY R0.L\(V\);
 600:	01 c6 1a 82 	R1=SHIFTR2 BY R3.L\(V\);
 604:	01 c6 35 88 	R4=SHIFTR5 BY R6.L\(V\);
 608:	01 c6 08 8e 	R7=SHIFTR0 BY R1.L\(V\);
 60c:	01 c6 23 84 	R2=SHIFTR3 BY R4.L\(V\);
 610:	01 c6 3e 8a 	R5=SHIFTR6 BY R7.L\(V\);
