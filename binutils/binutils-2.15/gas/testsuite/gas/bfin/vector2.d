...
00000000 <.text>:
 ...
 570:	01 c6 2f 04 	R2= ASHIFT R7BYR5.L\(V\);
 574:	01 c6 11 00 	R0= ASHIFT R1BYR2.L\(V\);
 578:	01 c6 2c 06 	R3= ASHIFT R4BYR5.L\(V\);
 57c:	01 c6 07 0c 	R6= ASHIFT R7BYR0.L\(V\);
 580:	01 c6 1a 02 	R1= ASHIFT R2BYR3.L\(V\);
 584:	01 c6 35 08 	R4= ASHIFT R5BYR6.L\(V\);
 588:	01 c6 08 0e 	R7= ASHIFT R0BYR1.L\(V\);
 58c:	01 c6 23 04 	R2= ASHIFT R3BYR4.L\(V\);
 590:	01 c6 3e 0a 	R5= ASHIFT R6BYR7.L\(V\);
 594:	01 c6 11 40 	R0= ASHIFT R1BYR2.L\(V,S\);
 598:	01 c6 2c 46 	R3= ASHIFT R4BYR5.L\(V,S\);
 59c:	01 c6 07 4c 	R6= ASHIFT R7BYR0.L\(V,S\);
 5a0:	01 c6 1a 42 	R1= ASHIFT R2BYR3.L\(V,S\);
 5a4:	01 c6 35 48 	R4= ASHIFT R5BYR6.L\(V,S\);
 5a8:	01 c6 08 4e 	R7= ASHIFT R0BYR1.L\(V,S\);
 5ac:	01 c6 23 44 	R2= ASHIFT R3BYR4.L\(V,S\);
 5b0:	01 c6 3e 4a 	R5= ASHIFT R6BYR7.L\(V,S\);
