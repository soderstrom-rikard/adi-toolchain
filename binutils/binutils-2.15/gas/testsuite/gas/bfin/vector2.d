...
00000000 <.text>:
  ...
  70:	06 c4 08 86 	R3=ABSR1\(V\);
  74:	06 c4 00 80 	R0=ABSR0\(V\);
  78:	06 c4 08 80 	R0=ABSR1\(V\);
  7c:	06 c4 18 84 	R2=ABSR3\(V\);
  80:	06 c4 28 88 	R4=ABSR5\(V\);
  84:	06 c4 38 8c 	R6=ABSR7\(V\);
  88:	06 c4 00 82 	R1=ABSR0\(V\);
  8c:	06 c4 10 86 	R3=ABSR2\(V\);
  90:	06 c4 20 8a 	R5=ABSR4\(V\);
  94:	06 c4 30 8e 	R7=ABSR6\(V\);
 ...
 244:	01 c4 0a 2e 	R0=R1\+|\+R2,R7=R1-|-R2;
 248:	01 c4 e5 2c 	R3=R4\+|\+R5,R6=R4-|-R5;
 24c:	01 c4 b8 2b 	R6=R7\+|\+R0,R5=R7-|-R0;
 250:	01 c4 53 28 	R1=R2\+|\+R3,R4=R2-|-R3;
 254:	01 c4 1d 27 	R4=R3\+|\+R5,R3=R3-|-R5;
 258:	01 c4 9f 25 	R6=R3\+|\+R7,R2=R3-|-R7;
 25c:	01 c4 0a 1e 	R0=R1\+|\+R2,R7=R1-|-R2;
 260:	01 c4 e5 1c 	R3=R4\+|\+R5,R6=R4-|-R5;
 264:	01 c4 b8 1b 	R6=R7\+|\+R0,R5=R7-|-R0;
 268:	01 c4 53 18 	R1=R2\+|\+R3,R4=R2-|-R3;
 26c:	01 c4 1d 17 	R4=R3\+|\+R5,R3=R3-|-R5;
 270:	01 c4 9f 15 	R6=R3\+|\+R7,R2=R3-|-R7;
 274:	01 c4 0a 3e 	R0=R1\+|\+R2,R7=R1-|-R2;
 278:	01 c4 e5 3c 	R3=R4\+|\+R5,R6=R4-|-R5;
 27c:	01 c4 b8 3b 	R6=R7\+|\+R0,R5=R7-|-R0;
 280:	01 c4 53 38 	R1=R2\+|\+R3,R4=R2-|-R3;
 284:	01 c4 1d 37 	R4=R3\+|\+R5,R3=R3-|-R5;
 288:	01 c4 9f 35 	R6=R3\+|\+R7,R2=R3-|-R7;
 ...
 2d4:	01 c4 0a 9e 	R0=R1\+|\+R2,R7=R1-|-R2;
 2d8:	01 c4 e5 9c 	R3=R4\+|\+R5,R6=R4-|-R5;
 2dc:	01 c4 b8 9b 	R6=R7\+|\+R0,R5=R7-|-R0;
 2e0:	01 c4 53 98 	R1=R2\+|\+R3,R4=R2-|-R3;
 2e4:	01 c4 1d 97 	R4=R3\+|\+R5,R3=R3-|-R5;
 2e8:	01 c4 9f 95 	R6=R3\+|\+R7,R2=R3-|-R7;
 2ec:	01 c4 0a be 	R0=R1\+|\+R2,R7=R1-|-R2;
 2f0:	01 c4 e5 bc 	R3=R4\+|\+R5,R6=R4-|-R5;
 2f4:	01 c4 b8 bb 	R6=R7\+|\+R0,R5=R7-|-R0;
 2f8:	01 c4 53 b8 	R1=R2\+|\+R3,R4=R2-|-R3;
 2fc:	01 c4 1d b7 	R4=R3\+|\+R5,R3=R3-|-R5;
 300:	01 c4 9f b5 	R6=R3\+|\+R7,R2=R3-|-R7;
 ...
 31c:	01 c4 0a de 	R0=R1\+|\+R2,R7=R1-|-R2;
 320:	01 c4 e5 dc 	R3=R4\+|\+R5,R6=R4-|-R5;
 324:	01 c4 b8 db 	R6=R7\+|\+R0,R5=R7-|-R0;
 328:	01 c4 53 d8 	R1=R2\+|\+R3,R4=R2-|-R3;
 32c:	01 c4 1d d7 	R4=R3\+|\+R5,R3=R3-|-R5;
 330:	01 c4 9f d5 	R6=R3\+|\+R7,R2=R3-|-R7;
 334:	01 c4 0a fe 	R0=R1\+|\+R2,R7=R1-|-R2;
 338:	01 c4 e5 fc 	R3=R4\+|\+R5,R6=R4-|-R5;
 33c:	01 c4 b8 fb 	R6=R7\+|\+R0,R5=R7-|-R0;
 340:	01 c4 53 f8 	R1=R2\+|\+R3,R4=R2-|-R3;
 344:	01 c4 1d f7 	R4=R3\+|\+R5,R3=R3-|-R5;
 348:	01 c4 9f f5 	R6=R3\+|\+R7,R2=R3-|-R7;
 ...
 368:	21 c4 0a 2e 	R0=R1\+|-R2,R7=R1-|\+R2;
 36c:	21 c4 e5 2c 	R3=R4\+|-R5,R6=R4-|\+R5;
 370:	21 c4 b8 2b 	R6=R7\+|-R0,R5=R7-|\+R0;
 374:	21 c4 53 28 	R1=R2\+|-R3,R4=R2-|\+R3;
 378:	21 c4 1d 27 	R4=R3\+|-R5,R3=R3-|\+R5;
 37c:	21 c4 9f 25 	R6=R3\+|-R7,R2=R3-|\+R7;
 380:	21 c4 0a 1e 	R0=R1\+|-R2,R7=R1-|\+R2;
 384:	21 c4 e5 1c 	R3=R4\+|-R5,R6=R4-|\+R5;
 388:	21 c4 b8 1b 	R6=R7\+|-R0,R5=R7-|\+R0;
 38c:	21 c4 53 18 	R1=R2\+|-R3,R4=R2-|\+R3;
 390:	21 c4 1d 17 	R4=R3\+|-R5,R3=R3-|\+R5;
 394:	21 c4 9f 15 	R6=R3\+|-R7,R2=R3-|\+R7;
 398:	21 c4 0a 3e 	R0=R1\+|-R2,R7=R1-|\+R2;
 39c:	21 c4 e5 3c 	R3=R4\+|-R5,R6=R4-|\+R5;
 3a0:	21 c4 b8 3b 	R6=R7\+|-R0,R5=R7-|\+R0;
 3a4:	21 c4 53 38 	R1=R2\+|-R3,R4=R2-|\+R3;
 3a8:	21 c4 1d 37 	R4=R3\+|-R5,R3=R3-|\+R5;
 3ac:	21 c4 9f 35 	R6=R3\+|-R7,R2=R3-|\+R7;
 ...
 3f8:	21 c4 0a 9e 	R0=R1\+|-R2,R7=R1-|\+R2;
 3fc:	21 c4 e5 9c 	R3=R4\+|-R5,R6=R4-|\+R5;
 400:	21 c4 b8 9b 	R6=R7\+|-R0,R5=R7-|\+R0;
 404:	21 c4 53 98 	R1=R2\+|-R3,R4=R2-|\+R3;
 408:	21 c4 1d 97 	R4=R3\+|-R5,R3=R3-|\+R5;
 40c:	21 c4 9f 95 	R6=R3\+|-R7,R2=R3-|\+R7;
 410:	21 c4 0a be 	R0=R1\+|-R2,R7=R1-|\+R2;
 414:	21 c4 e5 bc 	R3=R4\+|-R5,R6=R4-|\+R5;
 418:	21 c4 b8 bb 	R6=R7\+|-R0,R5=R7-|\+R0;
 41c:	21 c4 53 b8 	R1=R2\+|-R3,R4=R2-|\+R3;
 420:	21 c4 1d b7 	R4=R3\+|-R5,R3=R3-|\+R5;
 424:	21 c4 9f b5 	R6=R3\+|-R7,R2=R3-|\+R7;
 ...
 440:	21 c4 0a de 	R0=R1\+|-R2,R7=R1-|\+R2;
 444:	21 c4 e5 dc 	R3=R4\+|-R5,R6=R4-|\+R5;
 448:	21 c4 b8 db 	R6=R7\+|-R0,R5=R7-|\+R0;
 44c:	21 c4 53 d8 	R1=R2\+|-R3,R4=R2-|\+R3;
 450:	21 c4 1d d7 	R4=R3\+|-R5,R3=R3-|\+R5;
 454:	21 c4 9f d5 	R6=R3\+|-R7,R2=R3-|\+R7;
 458:	21 c4 0a fe 	R0=R1\+|-R2,R7=R1-|\+R2;
 45c:	21 c4 e5 fc 	R3=R4\+|-R5,R6=R4-|\+R5;
 460:	21 c4 b8 fb 	R6=R7\+|-R0,R5=R7-|\+R0;
 464:	21 c4 53 f8 	R1=R2\+|-R3,R4=R2-|\+R3;
 468:	21 c4 1d f7 	R4=R3\+|-R5,R3=R3-|\+R5;
 46c:	21 c4 9f f5 	R6=R3\+|-R7,R2=R3-|\+R7;
 ...
 4b8:	11 c4 36 02 	R0=A1\+A0,R1=A1-A0 \(NS\);
 4bc:	11 c4 b6 06 	R2=A1\+A0,R3=A1-A0 \(NS\);
 4c0:	11 c4 36 0b 	R4=A1\+A0,R5=A1-A0 \(NS\);
 4c4:	11 c4 b6 0f 	R6=A1\+A0,R7=A1-A0 \(NS\);
 4c8:	11 c4 68 00 	R1=A1\+A0,R0=A1-A0 \(NS\);
 4cc:	11 c4 f6 04 	R3=A1\+A0,R2=A1-A0 \(NS\);
 4d0:	11 c4 76 09 	R5=A1\+A0,R4=A1-A0 \(NS\);
 4d4:	11 c4 36 22 	R0=A1\+A0,R1=A1-A0 \(S\);
 4d8:	11 c4 b6 26 	R2=A1\+A0,R3=A1-A0 \(S\);
 4dc:	11 c4 36 2b 	R4=A1\+A0,R5=A1-A0 \(S\);
 4e0:	11 c4 b6 2f 	R6=A1\+A0,R7=A1-A0 \(S\);
 4e4:	11 c4 6d 20 	R1=A1\+A0,R0=A1-A0 \(S\);
 4e8:	11 c4 f6 24 	R3=A1\+A0,R2=A1-A0 \(S\);
 4ec:	11 c4 76 29 	R5=A1\+A0,R4=A1-A0 \(S\);
 4f0:	11 c4 36 6d 	R4=A0\+A1,R6=A0-A1 \(S\);
 4f4:	11 c4 36 42 	R0=A0\+A1,R1=A0-A1 \(NS\);
 4f8:	11 c4 b6 46 	R2=A0\+A1,R3=A0-A1 \(NS\);
 4fc:	11 c4 36 4b 	R4=A0\+A1,R5=A0-A1 \(NS\);
 500:	11 c4 b6 4f 	R6=A0\+A1,R7=A0-A1 \(NS\);
 504:	11 c4 6d 40 	R1=A0\+A1,R0=A0-A1 \(NS\);
 508:	11 c4 f6 44 	R3=A0\+A1,R2=A0-A1 \(NS\);
 50c:	11 c4 76 49 	R5=A0\+A1,R4=A0-A1 \(NS\);
 510:	11 c4 36 62 	R0=A0\+A1,R1=A0-A1 \(S\);
 514:	11 c4 b6 66 	R2=A0\+A1,R3=A0-A1 \(S\);
 518:	11 c4 36 6b 	R4=A0\+A1,R5=A0-A1 \(S\);
 51c:	11 c4 b6 6f 	R6=A0\+A1,R7=A0-A1 \(S\);
 520:	11 c4 6d 60 	R1=A0\+A1,R0=A0-A1 \(S\);
 524:	11 c4 f6 64 	R3=A0\+A1,R2=A0-A1 \(S\);
 528:	11 c4 76 69 	R5=A0\+A1,R4=A0-A1 \(S\);
 52c:	81 c6 d8 01 	R0=R0 << -5 \(V\);
 530:	81 c6 d9 01 	R0=R1 << -5 \(V\);
 534:	81 c6 db 05 	R2=R3 << -5 \(V\);
 538:	81 c6 dd 09 	R4=R5 << -5 \(V\);
 53c:	81 c6 df 0d 	R6=R7 << -5 \(V\);
 540:	81 c6 d8 03 	R1=R0 << -5 \(V\);
 544:	81 c6 da 07 	R3=R2 << -5 \(V\);
 548:	81 c6 dc 0b 	R5=R4 << -5 \(V\);
 54c:	81 c6 de 0f 	R7=R6 << -5 \(V\);
 550:	81 c6 29 40 	R0=R1 >>> -5 \(V, S\);
 554:	81 c6 2b 44 	R2=R3 >>> -5 \(V, S\);
 558:	81 c6 2d 48 	R4=R5 >>> -5 \(V, S\);
 55c:	81 c6 2f 4c 	R6=R7 >>> -5 \(V, S\);
 560:	81 c6 28 42 	R1=R0 >>> -5 \(V, S\);
 564:	81 c6 2a 46 	R3=R2 >>> -5 \(V, S\);
 568:	81 c6 2c 4a 	R5=R4 >>> -5 \(V, S\);
 56c:	81 c6 2e 4e 	R7=R6 >>> -5 \(V, S\);
 570:	01 c6 2f 04 	R2=ASHIFTR7BYR5.L\(V\);
 574:	01 c6 11 00 	R0=ASHIFTR1BYR2.L\(V\);
 578:	01 c6 2c 06 	R3=ASHIFTR4BYR5.L\(V\);
 57c:	01 c6 07 0c 	R6=ASHIFTR7BYR0.L\(V\);
 580:	01 c6 1a 02 	R1=ASHIFTR2BYR3.L\(V\);
 584:	01 c6 35 08 	R4=ASHIFTR5BYR6.L\(V\);
 588:	01 c6 08 0e 	R7=ASHIFTR0BYR1.L\(V\);
 58c:	01 c6 23 04 	R2=ASHIFTR3BYR4.L\(V\);
 590:	01 c6 3e 0a 	R5=ASHIFTR6BYR7.L\(V\);
 594:	01 c6 11 40 	R0=ASHIFTR1BYR2.L\(V,S\);
 598:	01 c6 2c 46 	R3=ASHIFTR4BYR5.L\(V,S\);
 59c:	01 c6 07 4c 	R6=ASHIFTR7BYR0.L\(V,S\);
 5a0:	01 c6 1a 42 	R1=ASHIFTR2BYR3.L\(V,S\);
 5a4:	01 c6 35 48 	R4=ASHIFTR5BYR6.L\(V,S\);
 5a8:	01 c6 08 4e 	R7=ASHIFTR0BYR1.L\(V,S\);
 5ac:	01 c6 23 44 	R2=ASHIFTR3BYR4.L\(V,S\);
 5b0:	01 c6 3e 4a 	R5=ASHIFTR6BYR7.L\(V,S\);
 ...
 5f4:	01 c6 11 80 	R0=SHIFTR1BYR2.L\(V\);
 5f8:	01 c6 2c 86 	R3=SHIFTR4BYR5.L\(V\);
 5fc:	01 c6 07 8c 	R6=SHIFTR7BYR0.L\(V\);
 600:	01 c6 1a 82 	R1=SHIFTR2BYR3.L\(V\);
 604:	01 c6 35 88 	R4=SHIFTR5BYR6.L\(V\);
 608:	01 c6 08 8e 	R7=SHIFTR0BYR1.L\(V\);
 60c:	01 c6 23 84 	R2=SHIFTR3BYR4.L\(V\);
 610:	01 c6 3e 8a 	R5=SHIFTR6BYR7.L\(V\);
 ...
 674:	90 c0 3c c8	a1 = R7.H \* R4.H \(M\), a0 \+= R7.L \* R3.L \(FU\);
