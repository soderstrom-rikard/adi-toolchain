...
00000000 <.text>:
  ...
  5c:	80 9d 00 00
  60:	0a cc 36 00 	R0.L=A0.x || R1=\[I0\+\+M1\] || NOP;
  64:	a1 9d 00 00
  68:	0a cc 36 4e 	R7.L=A1.x || R0=\[I0\+\+M2\] || NOP;
  6c:	c0 9d 00 00
  ...
  d4:	fd 9d 00 00
  d8:	83 ce 08 41 	A0=A0>>31 || R0=\[FP-32\] || NOP;
  dc:	80 b9 00 00
 ...
 10c:	e0 b9 00 00
 110:	80 ce f2 2b 	R5.H=R2.L<<0x3e || R0=\[FP-4\] || NOP;
 114:	f0 b9 00 00
 118:	00 ce 14 16 	R3.L= ASHIFT R4.HBYR2.L || R0=\[FP-100\] || NOP;
 11c:	70 b8 00 00
 120:	00 ce 07 6e 	R7.H= ASHIFT R7.LBYR0.L\)S\) || R0=\[FP-104\] || NOP;
 124:	60 b8 00 00
 128:	00 ce 07 6e 	R7.H= ASHIFT R7.LBYR0.L\)S\) || R0=\[FP-108\] || NOP;
 12c:	50 b8 00 00
 130:	02 ce 15 0c 	R6= ASHIFT R5BYR2.L || R0=\[FP-112\] || NOP;
 134:	40 b8 00 00
 138:	02 ce 0c 40 	R0= ASHIFT R4BYR1.L\)S\) || R3=\[FP-116\] || NOP;
 13c:	33 b8 00 00
 140:	02 ce 1e 44 	R2= ASHIFT R6BYR3.L\)S\) || R0=\[FP-120\] || NOP;
 144:	20 b8 00 00
 148:	03 ce 08 00 	A0= ASHIFT A0BYR1.L || R0=\[FP-124\] || NOP;
 14c:	10 b8 00 00
 150:	03 ce 00 10 	A1= ASHIFT A1BYR0.L || R0=\[FP-128\] || NOP;
 154:	00 b8 00 00
 ...
 16c:	17 94 00 00
 170:	82 ce 60 80 	R0=R0>>-12 || R5=W\[P2--\] \)Z\) || NOP;
 174:	95 94 00 00
 ...
 194:	d5 a7 00 00
 198:	00 ce 02 b2 	R1.H= LSHIFT R2.HBYR0.L || R5=W\[P2\+0x18\] \)Z\) || NOP;
 19c:	15 a7 00 00
 1a0:	00 ce 08 90 	R0.L= LSHIFT R0.HBYR1.L || R5=W\[P2\+0x16\] \)Z\) || NOP;
 1a4:	d5 a6 00 00
 1a8:	00 ce 16 8e 	R7.L= LSHIFT R6.LBYR2.L || R5=W\[P2\+0x14\] \)Z\) || NOP;
 1ac:	95 a6 00 00
 1b0:	02 ce 1c 8a 	R5=SHIFTR4BYR3.L || R4=W\[P2\+0x12\] \)Z\) || NOP;
 1b4:	54 a6 00 00
 1b8:	03 ce 30 40 	A0= LSHIFT A0BYR6.L || R5=W\[P2\+0x10\] \)Z\) || NOP;
 1bc:	15 a6 00 00
 1c0:	03 ce 28 50 	A1= LSHIFT A1BYR5.L || R5=W\[P2\+0xe\] \)Z\) || NOP;
 1c4:	d5 a5 00 00
 1c8:	82 ce 07 cf 	R7= ROT R7BY-32 || R5=W\[P2\+0xc\] \)Z\) || NOP;
 1cc:	95 a5 00 00
 1d0:	82 ce 0f cd 	R6= ROT R7BY-31 || R5=W\[P2\+0xa\] \)Z\) || NOP;
 1d4:	55 a5 00 00
 1d8:	82 ce ff ca 	R5= ROT R7BY0x1f || R6=W\[P2\+0x8\] \)Z\) || NOP;
 1dc:	16 a5 00 00
 1e0:	82 ce f7 c8 	R4= ROT R7BY0x1e || R5=W\[P2\+0x6\] \)Z\) || NOP;
 1e4:	d5 a4 00 00
 1e8:	83 ce 00 80 	A0= ROT A0BY0x0 || R5=W\[P3\] \)Z\) || NOP;
 1ec:	1d 95 00 00
 1f0:	83 ce 50 80 	A0= ROT A0BY0xa || R5=W\[P3\+\+\] \)Z\) || NOP;
 1f4:	1d 94 00 00
 1f8:	83 ce 60 91 	A1= ROT A1BY-20 || R5=W\[P3--\] \)Z\) || NOP;
 1fc:	9d 94 00 00
 200:	83 ce 00 91 	A1= ROT A1BY-32 || R5=W\[P4\] \)Z\) || NOP;
 204:	25 95 00 00
 208:	02 ce 11 c0 	R0= ROT R1BYR2.L || R5=W\[P4\+\+\] \)Z\) || NOP;
 20c:	25 94 00 00
 210:	02 ce 1c c0 	R0= ROT R4BYR3.L || R5=W\[P4--\] \)Z\) || NOP;
 214:	a5 94 00 00
 218:	03 ce 38 80 	A0= ROT A0BYR7.L || R5=W\[P5\] \)Z\) || NOP;
 21c:	2d 95 00 00
 220:	03 ce 30 90 	A1= ROT A1BYR6.L || R5=W\[P5\+\+\] \)Z\) || NOP;
 224:	2d 94 00 00
