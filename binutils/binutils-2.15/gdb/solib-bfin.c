...
_initialize_bfin_solib (void)
{
  ...
  deprecated_add_show_from_set
    (add_set_cmd ("solib-bfin", class_maintenance, var_zinteger,
		  &solib_bfin_debug,
"Set internal debugging of shared library code for BFIN.\n"
