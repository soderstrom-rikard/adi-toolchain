...
#define DSP32Cmul_opcode		0xc7000000
#define DSP32Cmul_src1_bits		0
#define DSP32Cmul_src1_mask		0x7
#define DSP32Cmul_src0_bits		3
#define DSP32Cmul_src0_mask		0x7
#define DSP32Cmul_dst_bits		6
#define DSP32Cmul_dst_mask		0x7
#define DSP32Cmul_conj_bits		10
#define DSP32Cmul_conj_mask		0x3
#define DSP32Cmul_P_bits		12
#define DSP32Cmul_P_mask		0x1
#define DSP32Cmul_w_bits		13
#define DSP32Cmul_w_mask		0x1
#define DSP32Cmul_aop_bits		14
#define DSP32Cmul_aop_mask		0x3
#define DSP32Cmul_mmod_bits		16
#define DSP32Cmul_mmod_mask		0xf
#define DSP32Cmul_code2_bits		21
#define DSP32Cmul_code2_mask		0x3f
#define DSP32Cmul_M_bits		27
#define DSP32Cmul_M_mask		0x1
#define DSP32Cmul_code_bits		28
#define DSP32Cmul_code_mask		0xf

#define init_DSP32Cmul						\
{								\
  DSP32Cmul_opcode,						\
  DSP32Cmul_src1_bits,		DSP32Cmul_src1_mask,		\
  DSP32Cmul_src0_bits,		DSP32Cmul_src0_mask,		\
  DSP32Cmul_dst_bits,		DSP32Cmul_dst_mask,		\
  DSP32Cmul_conj_bits,		DSP32Cmul_conj_mask,		\
  DSP32Cmul_P_bits,		DSP32Cmul_P_mask,		\
  DSP32Cmul_w_bits,		DSP32Cmul_w_mask,		\
  DSP32Cmul_aop_bits,		DSP32Cmul_aop_mask,		\
  DSP32Cmul_mmod_bits,		DSP32Cmul_mmod_mask,		\
  DSP32Cmul_code2_bits,		DSP32Cmul_code2_mask,		\
  DSP32Cmul_M_bits,		DSP32Cmul_M_mask,		\
  DSP32Cmul_code_bits,		DSP32Cmul_code_mask		\
};
...
#define DSP32Csqu_opcode		0xc7200000
#define DSP32Csqu_src1_bits		0
#define DSP32Csqu_src1_mask		0x7
#define DSP32Csqu_src0_bits		3
#define DSP32Csqu_src0_mask		0x7
#define DSP32Csqu_dst_bits		6
#define DSP32Csqu_dst_mask		0x7
#define DSP32Csqu_P_bits		9
#define DSP32Csqu_P_mask		0x1
#define DSP32Csqu_w1_bits		10
#define DSP32Csqu_w1_mask		0x1
#define DSP32Csqu_w0_bits		11
#define DSP32Csqu_w0_mask		0x1
#define DSP32Csqu_op1_bits		12
#define DSP32Csqu_op1_mask		0x3
#define DSP32Csqu_op0_bits		14
#define DSP32Csqu_op0_mask		0x3
#define DSP32Csqu_mmod_bits		16
#define DSP32Csqu_mmod_mask		0xf
#define DSP32Csqu_code2_bits		21
#define DSP32Csqu_code2_mask		0x3f
#define DSP32Csqu_M_bits		27
#define DSP32Csqu_M_mask		0x1
#define DSP32Csqu_code_bits		28
#define DSP32Csqu_code_mask		0xf

#define init_DSP32Csqu						\
{								\
  DSP32Csqu_opcode,						\
  DSP32Csqu_src1_bits,		DSP32Csqu_src1_mask,		\
  DSP32Csqu_src0_bits,		DSP32Csqu_src0_mask,		\
  DSP32Csqu_dst_bits,		DSP32Csqu_dst_mask,		\
  DSP32Csqu_P_bits,		DSP32Csqu_P_mask,		\
  DSP32Csqu_w1_bits,		DSP32Csqu_w1_mask,		\
  DSP32Csqu_w0_bits,		DSP32Csqu_w0_mask,		\
  DSP32Csqu_op1_bits,		DSP32Csqu_op1_mask,		\
  DSP32Csqu_op0_bits,		DSP32Csqu_op0_mask,		\
  DSP32Csqu_mmod_bits,		DSP32Csqu_mmod_mask,		\
  DSP32Csqu_code2_bits,		DSP32Csqu_code2_mask,		\
  DSP32Csqu_M_bits,		DSP32Csqu_M_mask,		\
  DSP32Csqu_code_bits,		DSP32Csqu_code_mask		\
};
